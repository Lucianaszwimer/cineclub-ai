...
export const INTENT_SYSTEM_PROMPT = `Sos un asistente de un cineclub. Analizá el último mensaje del usuario y devolvé UNICAMENTE un JSON válido que cumpla exactamente con este esquema:
