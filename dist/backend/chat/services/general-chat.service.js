...
let GeneralChatService = class GeneralChatService {
    constructor(config) {
        this.config = config;
    ...
    async answer(messages) {
        ...
        return ((_b = (_a = response.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) || '¿En qué te puedo ayudar hoy con tu cineclub?';
    }
};
exports.GeneralChatService = GeneralChatService;
exports.GeneralChatService = GeneralChatService = __decorate([
